...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ShowImage,
      @NonNull Button button5, @NonNull Button button6, @NonNull Button button7,
      @NonNull EditText edEmail, @NonNull EditText edName, @NonNull EditText edPassword) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, ShowImage, button5, button6,
          button7, edEmail, edName, edPassword);
    }
