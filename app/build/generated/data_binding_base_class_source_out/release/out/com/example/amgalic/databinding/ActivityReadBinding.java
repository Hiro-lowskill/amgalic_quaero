...
public final class ActivityReadBinding implements ViewBinding {
  ...
  private ActivityReadBinding(@NonNull ConstraintLayout rootView, @NonNull Button button3,
      @NonNull Button button4, @NonNull ListView listView) {
  ...
  public static ActivityReadBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityReadBinding((ConstraintLayout) rootView, button3, button4, listView);
    }
